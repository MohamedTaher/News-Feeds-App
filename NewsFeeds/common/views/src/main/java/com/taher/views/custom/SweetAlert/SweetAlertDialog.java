package com.taher.views.custom.SweetAlert;
...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
    ...
    public SweetAlertDialog(Context context, int alertType, Drawable warningDrawable) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        warningImageView = (ImageView) findViewById(R.id.sweet_alert_warning_imageView);
        ...
        if (warningDrawable != null)
            warningImageView.setImageDrawable(warningDrawable);
